...
<head>
  ...
  <link rel="stylesheet" href=" {{ asset('skin/css/index.css') }}">
  ...
  <script type="text/javascript" src="{{ asset('skin/js/jquery.superslide.2.1.1.js') }}"></script>
      ...
      <div class="head">
        <div class="top">
          <div class="top_1">
            ...
            <div class="fr_jl">
              <ul>
                <li style="background:{{ asset('skin/images/home.gif')}} no-repeat left 15px;"><a href="/">设为首页</a></li>
        ...
        <div class="con">
          <div class="top_2">
            <div style="float:left; margin-top:25px;"><img src= "{{ asset('skin/images/logo.png') }}" /></div>
