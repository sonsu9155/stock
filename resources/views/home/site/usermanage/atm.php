...
$(document).ready(function() {
	...
	$("#AtmForm").validate({
		rules: {
			money: {required:true, number:true, range:[1,25234.89]},
		...
		messages: {
			money: {required: "请输入要提款的金额.", range: "提款金额必须在1-25234.89之间"},
