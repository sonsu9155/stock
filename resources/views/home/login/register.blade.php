    ...
    <div class="zhuce">
        <div class="center c-zhuce">
            <div class="zhuce-box">
                ...
                <div class="zc-name mleft" {{ $errors->has('name') ? 'has-error' : '' }} >
                    <span>开户人姓名：</span>
                ...
                @endif
                <div class="zc-name mleft" {{ $errors->has('phonenum') ? 'has-error' : '' }}>
                    <span>手机号码：</span>
                ...
                <span class="text-danger" style="color: red;">{{ $errors->first('phonenum') }}</span>
                @endif
                ...
                <span class="text-danger" style="color: red;">{{ $errors->first('captcha') }}</span>
                @endif
                <div class="zc-yzma mleft" hidden>
                    <span>验证号码：</span>
                    <input class="tooltip" data-val="true" data-val-required="验证码 字段是必需的。" id="VerificationCode" name="phonenum_verified_at" placeholder="获取到的验证码" title="请输入手机获取到的数字验证码。" type="text" value="{{ rand(1000,9999) }}" />
                ...
                <span class="text-danger" style="color: red;">{{ $errors->first('realname') }}</span>
                @endif
                <div class="zc-mima mleft">
                    <span>身份证号码：</span>
                ...
                <span class="text-danger" style="color: red;">{{ $errors->first('idcard') }}</span>
                @endif
                <div class="zc-mima mleft">
                    <span>开户行账号：</span>
                ...
                <span class="text-danger" style="color: red;">{{ $errors->first('cardnum') }}</span>
                @endif
                <div class="zc-mima mleft">
                    <span>开户行地址：</span>
                ...
                @if ($errors->has('cardbank'))
                <span class="text-danger" style="color: red;">{{ $errors->first('cardbank') }}</span>
                @endif
                <div class="zc-mima mleft">
                    <span>登录密码：</span>
                ...
                <span class="text-danger" style="color: red;">{{ $errors->first('confirmpassword') }}</span>
                @endif
