...
SwitchBarPos=0
SwitchBarScheme=0
Url=http://##tdxcloudaddress_tp##/site/kggx/tk_hy.html?id=247&color=##tdxbk##
CurUrlSel=0
ZSCheck=1
AutoRefreshMin=0
ForceUseIECheck=0
...
SwitchBarPos=1
SwitchBarScheme=5
CfgName=hycyl_mems102
[STEP9]
SplitWhich=-2
UnitStr=主要MEMS传感器代工厂商
UnitDesc=
UnitGlStr=
UnitType=BIGDATA_UNIT
UnitStyle=ZST_BIG
