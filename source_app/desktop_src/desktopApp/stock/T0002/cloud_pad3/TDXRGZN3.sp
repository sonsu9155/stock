...
SwitchBarPos=0
SwitchBarScheme=0
Url=http://##tdxcloudaddress_tp##/site/kggx/tk_hy.html?id=3&color=##tdxbk##
CurUrlSel=0
ZSCheck=1
AutoRefreshMin=0
ForceUseIECheck=0
