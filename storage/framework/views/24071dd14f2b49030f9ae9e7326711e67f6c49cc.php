...
<head>
    ...
    <body> 
    <?php echo $__env->make('layouts.web_top', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div class ="row" >
        <div class ="col-sm-2">
            <div class="user_ii" >
                用户：<strong><font color="#000"><?php echo e($user->username); ?></font></strong>
                &nbsp;
                <br>
                保证金: <br><span style="color:#000"><span id="a_money"><?php echo e(number_format($money_wallet->after_amount + $money_wallet->before_amount -$stock_wallet->after_amount, 2)); ?></span></span>元
