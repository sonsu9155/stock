...
<?php $__env->startSection('content'); ?>
    <div class="nav">
        <!-- <div class="container">
            <a href="javascript:;" class="brand"><span style="margin-top: -10px;width: 134px;height: 55px;"><img style="width: 134px; height: 55px;" src="images/logo4.png" width="140" height="50" alt=""></span><p style="float: left;font-size: 16px;margin-bottom: 0px;margin-top: 8px;margin-left: 20px;">人人会用的加密货币充值兑换工具</p></a>
        </div> -->
    </div>
                        ...
                        <div class="order-channel" style="height:100%;">
                            <div class="order-channel-head">
                                <ul>
                                    ...
                                    <li><b>卖家信用</b></li>
                                        <li><b>订单金额：<?php echo e($money); ?>元</b></li>
