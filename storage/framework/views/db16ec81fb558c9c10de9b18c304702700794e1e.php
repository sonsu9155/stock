...
<script>
	$(function(){
		...
		// if (id_org.substing(0,1) =='6'){
		// 	id = 'sh'+id_org;
		// }else{
		// 	id = 'sz'+id_org;
		// }
		
		var furl = 'http://quotes.sina.cn/hs/company/quotes/view/'+id+'/?from=wap';
		$('.sxsx').attr('src',furl);
		//alert('furl');
		var furl = 'http://image.sinajs.cn/newchart/min/n/'+id+'.gif';
		$('.k1').attr('src',furl);
		var furl = 'http://image.sinajs.cn/newchart/daily/n/'+id+'.gif';
		$('.k2').attr('src',furl);
		var furl = 'http://image.sinajs.cn/newchart/weekly/n/'+id+'.gif';
		$('.k3').attr('src',furl);
		var furl = 'http://image.sinajs.cn/newchart/monthly/n/'+id+'.gif';
		$('.k4').attr('src',furl);
...
<br>
<!-- <a href="stock.php" style="color: #fff; text-decoration: none;">< 返回大盘</a> -->
<br>
<br>
