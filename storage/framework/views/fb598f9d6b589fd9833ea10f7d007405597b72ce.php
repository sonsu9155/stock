...
<meta http-equiv="refresh" content="60">
	<div style="width:100%; height:288px;">
		...
		<div style="width:33%; height:357px; float:left;background-image:url(/images/rzhong.png);" >
            ...
            <div style="width:100%; height:40px;margin-left:10px;">可用金额： <input type="text" id="spn_cancash" style="width:100px;" readonly="readonly" value="<?php echo e($moneywallet->after_amount); ?>"  /></div>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center"  bordercolor="#CCCCCC">    
          ...
          <tr border="0" >
            <td height="33px" align="center" id="inf_<?php echo e($index + 1); ?>" style="display:none;" value="<?php echo e($buyhistory->cost); ?>,<?php echo e($buyhistory->method); ?>,<?php echo e($buyhistory->amount); ?>,<?php echo e($buyhistory->fee * $buyhistory->amount *100 * $buyhistory->cost); ?>,<?php echo e($setting->cost_sell_max); ?>,<?php echo e($setting->cost_save_max); ?>, <?php echo e($buyhistory->cost * 0); ?>">00006420</td>
            <td height="33px" align="center"><?php echo e($buyhistory->id); ?> </a></td>
            <td align="center"><?php echo e($buyhistory->stockType->cn_name); ?></a></td>
            <td align="center"><font color="#FF0000"><?php echo e($buyhistory->method); ?></font></td>
            <td align="center"><?php echo e($buyhistory->cost); ?></td>
            <td align="center"><?php echo e($buyhistory->amount); ?></td>
            <td align="center"><?php echo e($buyhistory->cost * $buyhistory->amount *100); ?></td>
            <td align="center"><?php echo e($buyhistory->fee * $buyhistory->cost * $buyhistory->amount *100); ?></td>
            <td align="center" id="cur_price_<?php echo e($index + 1); ?>"></td>
            <td align="center" id="gain_<?php echo e($index + 1); ?>"></td>
            <td align="center"><?php echo e($buyhistory->created_at); ?></td>
            <td align="center"><a href="/pc/sale_buy?id=<?php echo e($buyhistory->id); ?>" ><input type="button" name="Submit" value="平仓" class="button3"  ensabled /></a></td>
          </tr>
