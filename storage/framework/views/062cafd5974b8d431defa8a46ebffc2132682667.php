...
<body>
  ...
  <form name="sell_stock" id="sell_stock" method="post" action="/site/sell_act">
    <tr bgcolor="#FFFFFF">
      <td width="29%" align="right">股票名称：</td>
      <td width="71%"><?php echo e($buyhistory->stockType->cn_name); ?></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right">股票代码：</td>
      <td><span id="buy_code"><?php echo e($buyhistory->stockType->code); ?></span></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right">持仓时间：</td>
      <td id="created_at"><?php echo e($buyhistory->created_at); ?></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right">持仓数量：</td>
      <td><?php echo e($buyhistory->amount); ?>(手) 可卖:<?php echo e($buyhistory->amount); ?>(手) </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right">买入价格：</td>
      <td><span id="spn_bull_price"><?php echo e($buyhistory->cost); ?></span>　<font color=red>买升↑</font> </td>
    </tr>
    <tr bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><table  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><input name="price_type" type="radio" value="1" checked="checked" style="vertical-align:middle;" onclick="$('#span_price').css('display','none');" />
市价
      </table></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right">卖出数量：</td>
      <td><input type="text" name="num" id="num" value=<?php echo e($buyhistory->amount); ?> size="5"/>&nbsp;<button name="btnAll" class="button_small" onclick="$('#num').val(<?php echo e($buyhistory->amount); ?>);" style="vertical-align:middle;">全部</button></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right">&nbsp;</td>
      <td><button name="Submit" id="btnsell"  class="button_small">卖出</button> 
      <input name="id" type="hidden" id="id" value="<?php echo e($buyhistory->id); ?>" />
