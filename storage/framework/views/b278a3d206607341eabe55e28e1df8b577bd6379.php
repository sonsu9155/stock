...
<?php echo e(csrf_field()); ?>
  ...
  <table width="99%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" class="mybox">
    ...
    <tr bgcolor="#EDF8FF">
      ...
      <td> <span class="money">￥<?php echo e(number_format( $money_wallet->after_amount + $money_wallet->before_amount -$stock_wallet->after_amount  - $fund_amount , 2)); ?></span></td>
    </tr>
    <tr bgcolor="#EDF8FF">
    ...
    <td><input name="kh_bank" type="text" id="kh_bank" value=<?php echo e($user->kh_bank); ?>  size="30"> </td>
    </tr> 
    <tr bgcolor="#EDF8FF"  hidden>
      <td align="right">帐 户 名：</td>
      <td><input name="realname" type="text" id="realname" size="30" value=<?php echo e($user->name); ?> readonly> &nbsp;<span class="gray"></span></td>
    </tr>
    <tr bgcolor="#EDF8FF"  hidden>
      <td align="right">银行名称：</td>
      <td><input name="bankname" type="text"  size="30" value="" readonly="readonly"><?php echo e($user->bank_name); ?></td>
    </tr>
    <tr bgcolor="#EDF8FF"  hidden>
      <td align="right">银行帐号：</td>
      <td><input name="bankno" type="text" id="bankno" size="30" value=<?php echo e($user->bank_card); ?> readonly="readonly"></td>
    </tr>
    <tr bgcolor="#EDF8FF">
