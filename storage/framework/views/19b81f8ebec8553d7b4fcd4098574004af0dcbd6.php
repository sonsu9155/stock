...
<form id="regform" name="regform" action="user.php?type=save" method="post">
    <table width="99%"  border="0" align="center" cellpadding="3" cellspacing="1" class="mybox">
      ...
      <tr>
        ...
        <td bgcolor="#3f4042" class="gray" style="text-align: center;"><span class="money" >￥<?php echo e(number_format($stock_wallet->before_amount -$fund_amount, 2)); ?></span></td>
        ...
        <td bgcolor="#3f4042" class="gray" style="text-align: center;border: 1px solid black;">
          <span class="money">
            <?php if($money_wallet->before_amount >  $money_wallet->after_amount + $money_wallet->before_amount - $stock_wallet->after_amount -$fund_amount): ?>
              ￥ 0
            <?php else: ?>
              ￥ <?php echo e($money_wallet->after_amount - $stock_wallet->after_amount - $fund_amount); ?>
      ...
      <tr>
        ...
        <td bgcolor="#3f4042" class="gray" style="text-align: center;border: 1px solid black;">
          <span class="money">
            <?php if($money_wallet->before_amount > $money_wallet->after_amount + $money_wallet->before_amount - $stock_wallet->after_amount - $fund_amount): ?>
              ￥ <?php echo e($stock_wallet->after_amount + $fund_amount - $money_wallet->after_amount); ?>
