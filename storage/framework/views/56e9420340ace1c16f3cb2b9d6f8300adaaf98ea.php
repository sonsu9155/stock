...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" class="mybox" style="margin-top:10px;">
  ...
  <?php $__currentLoopData = $sell_histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sell_history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr align="center"  onMouseOver="this.style.background='#3f4042';" onMouseOut="this.style.background='#3f4042';">
      ...
      <td style="border: 1px solid black;"><?php echo e($sell_history->buy_fee * $sell_history->amount * $sell_history->sell_cost * 100); ?></td>
...
<table width="99%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" class="mybox" style="margin-top:10px;">
  <tr>
    <th colspan="8" class="text-center">汇总信息</th>
  </tr>
  <tr align="center" bgcolor="#C5E2FB">
    ...
    <td width="12%" style="border: 1px solid black;">本月交易量</td>
    <td width="12%" style="border: 1px solid black;">保证金</td>
    <td width="12%" style="border: 1px solid black;">可用额度</td>
  </tr>
  <tr align="center"  onMouseOver="this.style.background='#3f4042';" onMouseOut="this.style.background='#FFFFFF';">
    <td id="brsy" style="border: 1px solid black;">&nbsp;</td>
    <td id="lcf" style="border: 1px solid black;">&nbsp;</td>
    <td id="brjl" style="border: 1px solid black;">&nbsp;</td>
    <td id="brye"style="border: 1px solid black;">&nbsp;</td>
