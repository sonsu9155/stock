  ...
  <tr>
      ...
      <table border="0" width="98%" cellspacing="1" cellpadding="3" align="center" bgcolor="#CCCCCC">
        <tr>
          <td align="center" width="20%" height="20" bgcolor="#FAFAFA">
            ...
            <td align="center" width="20%" height="20" bgcolor="#FAFAFA"><a href="?type=date&date=2019-05-11"><?php echo e(date('Y-m-d')); ?></a></td>
            <td align="center" width="20%" height="20" bgcolor="#FAFAFA"><a href="?type=date&date=2019-05-10"><?php echo e(date('Y-m-d')); ?></a></td>
            <td align="center" width="20%" height="20" bgcolor="#FAFAFA"><a href="?type=date&date=2019-05-09"><?php echo e(date('Y-m-d')); ?></a></td>
            <td align="center" width="20%" height="20" bgcolor="#FAFAFA"><a href="?type=date&date=2019-05-08"><?php echo e(date('Y-m-d')); ?></a></td>
          </tr>
        </table>
      </td>
    <td width="25%" align="center" bgcolor="#3f4042">
      <form name="form1" method="get" action="">
        ...
        <input name="date" id="txt_date" type="text" value="2019-05-12" class="datepicker"/>
...
<table width='98%' border='0' align="center" cellpadding='3' cellspacing='1' class="mybox">
  ...
  <tr align="center" bgcolor="#3f4042" onMouseOver="this.style.background='#3f4042';" onMouseOut="this.style.background='#3f4042';">
    ...
    <td style="border: 1px solid black;"> <?php echo e($buy_history->cost); ?> * <?php echo e($buy_history->amount); ?> </td>
