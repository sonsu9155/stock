...
<body style="background: #1c1b29;">
    ...
    <div>
        ...
        <ul class="top_table clearfix">
            <li class="row1">买入手续费：<span class="gray"><?php echo e($setting->cost_bull_max * 100); ?>%</span></li>
            <li class="row2">卖出手续费：<span class="gray"><?php echo e($setting->cost_sell_max * 100); ?>%</span></li>
            <li class="row3">留仓费：<span class="gray"><?php echo e($setting->cost_save_max * 100); ?>‰ </span></li>
