...
<div class="head">
   <div class="top">
    <div class="top_1">
       ...
       <div class="fr_jl">
        <ul>
           <li style="background:<?php echo e(asset('skin/images/home.gif')); ?> no-repeat left 15px;"><a href="index">设为首页</a></li>
           <li style="background:<?php echo e(asset('skin/images/shoucang.gif')); ?> no-repeat left 15px;"><a href="javascript:window.external.AddFavorite('http://test.com','财智通')">加入收藏</a></li>
   ...
   <div class="con">
    <div class="top_2">
       <div style="float:left; margin-top:25px;"><img src= "<?php echo e(asset('skin/images/logo.png')); ?>" alt=""/></div>
     </div>
  </div>
   <div class="nav">
    <div class="top_3">
       <ul>
        ...
        <!-- <li><a href="<?php echo e(url('new/index')); ?>">新闻中心</a></li> -->
        
        <li><a href="<?php echo e(url('pro/index')); ?>">产品资讯</a></li>
        
        <li><a href="<?php echo e(url('zp/index')); ?>">交易规则</a></li>
<!--         
        <li><a href="<?php echo e(url('zs/index')); ?>">招商中心</a></li> -->
