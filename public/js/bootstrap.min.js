...
/*!
 * Generated using the Bootstrap Customizer (http://v3.bootcss.com/customize/?id=f2ae135334165e2cef68)
 * Config saved to config.json and https://gist.github.com/f2ae135334165e2cef68
 */
...
;(function($, window, undefined) {
    ...
    $.fn.dropdownHover = function(options) {
        ...
        return this.each(function() {
            ...
            $this.hover(function() {
            	var $this = $(this);
            	var relatedTarget = { relatedTarget: _this }
                $this.trigger(e = $.Event('show.bs.dropdown', relatedTarget))
