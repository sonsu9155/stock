...
var UUID_BASE = 0;
var THIS_SWF_NAME = LSS_SITE+"vvMedia.swf?v=1212131";// + new Date().getTime();
			...
			case RTMP_MEDIA_READY:	//swf加载完成消息
				  _this.onSwfReady();
				   _this.initArgc(_this._adveDeAddr,_this._adveReAddr,_this._adveWidth,_this._adveHeight,_this._controlbardisplay,_this._logoAddr,_this._logoPosition,_this._lssServer,_this._logoAlpha,_this._openaddress,_this._password,
				  	...
				  	_this._supernatantword, _this._displayfrequen, _this._scrollposition, _this._buffertitle, _this._isclickplay, _this._isfullscreen,_this._bufferTime, _this._loadswitch);
...
function lssCreateSWFVideo(id, uuid, width, height, param) {
	...
	var xiSwfUrlStr = LSS_SITE + "playerProductInstall.swf";
	var flashvars = {};
	flashvars.uuid = uuid;
	var params = {};
